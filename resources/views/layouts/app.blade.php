  ...
  <div class="w-70 mx-auto md:mx-0 md:mr-5">
    ...
    >
      ...
      <form action="#" method="POST" class="space-y-4 px-4 py-6">
        <div>
          <input type="text" class="bg-gray-100 w-full rounded-xl text-sm border-none placeholder-gray-900 px-4 py-2" placeholder="Your idea">
        </div>
        ...
        <div>
          <textarea name="idea" id="idea" cols="30" rows="4" placeholder="Describe your idea!" class="w-full bg-gray-100 rounded-xl border-none placeholder-gray-900 text-sm px-4 py-2 resize-y" ></textarea>
        </div>
