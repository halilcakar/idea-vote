    ...
    >
      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <form wire:submit.prevent="updateIdea" action="#" method="POST" class="space-y-4 px-4 py-6">
          <div>
            <input wire:model.defer="title" x-ref="ideaTitle" type="text" class="bg-gray-100 w-full rounded-xl text-sm border-none placeholder-gray-900 px-4 py-2" placeholder="Your idea" required>
            @error('title')
