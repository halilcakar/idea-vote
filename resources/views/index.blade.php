<x-app-layout>
    ...
    <div class="ideas-container space-y-6 py-6">
            ...
            <div class="flex flex-col md:flex-row flex-1 px-2 py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-2 md:mx-4">
                    <h4 class="text-xl font-semibold mt-4 md:mt-0">
                        <a href="#" class="hover:underline line-clamp-1 md:line-clamp-none">Yet another random title can go here!</a>
                    </h4>
        ...
        <div class="hidden md:flex idea-container cursor-pointer bg-white rounded-xl  hover:shadow-card transition duration-150 ease-in">
