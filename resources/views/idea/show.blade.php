        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
          ...
          <div x-data="{ isOpen: false }" class="flex items-center space-x-2 mt-4 md:mt-0">
            ...
            >
              ...
              >
                <li><a href="#" class="hover:bg-gray-100 block px-5 py-3 transition duration-150 ease-in">Mark as
                    Spam</a></li>
                <li><a href="#" class="hover:bg-gray-100 block px-5 py-3 transition duration-150 ease-in">Delete
                    Post</a></li>
              </ul>
            </button>
          </div>
  ...
  <div class="comments-container relative space-y-6 md:ml-22 pt-4 my-8 mt-1">
      ...
      <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
        ...
        <div class="w-full md:mx-4">
          ...
          <div class="text-gray-600">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cum adipisci tenetur fugiat rem enim facilis
            repellendus non hic quasi ipsam, ipsa omnis placeat eveniet veritatis tempore mollitia sequi obcaecati
            molestias!
          </div>
    ...
    <div class="is-admin comment-container relative bg-white rounded-xl flex mt-4">
      <div class="flex flex-1 px-4 py-6">
        <div class="flex-none">
          <a href="#">
            <img src="https://source.unsplash.com/200x200/?face&crop=face&v=3" class="w-14 h-14 rounded-xl"
                 alt="avatar">
          </a>
    ...
    <div class="comment-container relative bg-white rounded-xl flex mt-4">
      <div class="flex flex-1 px-4 py-6">
        <div class="flex-none">
          <a href="#">
            <img src="https://source.unsplash.com/200x200/?face&crop=face&v=4" class="w-14 h-14 rounded-xl"
                 alt="avatar">
          </a>
        </div>
        <div class="w-full mx-4">
